...
BOARD_RECOVERY_BOARD_NAME := SRPTH19D009RU
...
BOARD_RECOVERY_MKBOOTIMG_ARGS += --second_offset 0x10000000
BOARD_RECOVERY_MKBOOTIMG_ARGS += --dtb_offset 0x100000000
BOARD_RECOVERY_MKBOOTIMG_ARGS += --header_version 2

BOARD_VENDOR_BOOT_MKBOOTIMG_ARGS += --dtb_offset 0x101f00000
BOARD_VENDOR_BOOT_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION)

TARGET_KERNEL_ARCH := arm64
TARGET_KERNEL_LLVM_BINUTILS := true
TARGET_KERNEL_ADDITIONAL_FLAGS += LLVM=1 ARCH=arm64
